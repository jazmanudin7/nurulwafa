...
class Laporan extends CI_Controller
{
	...
	function cetakSantri()
	{
		...
		$data['jk']				= $jk;
		$data['data']           = $this->Model_laporan->getListSantri($nps, $jk, $kode_kelas, $kode_asrama)->result();
	...
	function cetakSuratIzin()
	{
		...
		$data['tahun_ajaran']	= $tahun_ajaran;
		$data['semester']		= $semester;
		$data['data']           = $this->Model_laporan->getSuratIzin($dari, $sampai, $nps, $tahun_ajaran, $semester)->result();
		if (isset($_POST['export'])) {
			header("Content-type: application/vnd-ms-excel");
