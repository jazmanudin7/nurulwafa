                        ...
                        ?>
                            <tr>
                                ...
                                while (strtotime($dari) <= strtotime($sampai)) {
                                    ...
                                    santri.nama_santri,
                                    santri.nps,
                                    MAX(IF (absensi_kehadiran.tanggal = '$dari' , keterangan , '')) AS keterangan,
                                    COUNT(CASE WHEN keterangan = 'Alfa' AND absensi_kehadiran.tanggal = '$dari'  THEN '' END) AS alfa,
                                    COUNT(CASE WHEN keterangan = 'Izin' AND absensi_kehadiran.tanggal = '$dari'  THEN '' END) AS izin,
                                    COUNT(CASE WHEN keterangan = 'Hadir' AND absensi_kehadiran.tanggal = '$dari'  THEN '' END) AS hadir,
                                    COUNT(CASE WHEN keterangan = 'Sakit' AND absensi_kehadiran.tanggal = '$dari'  THEN '' END) AS sakit
                                    FROM santri
                                    LEFT JOIN absensi_kehadiran_detail ON absensi_kehadiran_detail.nps = santri.nps 
                                    LEFT JOIN absensi_kehadiran ON absensi_kehadiran.no_absensi = absensi_kehadiran_detail.no_absensi 
                                    WHERE absensi_kehadiran_detail.nps = '$d->nps' AND absensi_kehadiran.tahun_ajaran = '$tahun_ajaran' AND absensi_kehadiran.semester = '$semester'
                                    ")->row_array();
