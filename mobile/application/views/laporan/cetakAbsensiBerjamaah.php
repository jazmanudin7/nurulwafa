                        ...
                        ?>
                            <tr>
                                ...
                                while (strtotime($dari) <= strtotime($sampai)) {
                                    ...
                                    WHERE absensi_berjamaah_detail.nps = '$d->nps' AND absensi_berjamaah.shalat = '$shalat' AND absensi_berjamaah.tahun_ajaran = '$tahun_ajaran' AND absensi_berjamaah.semester = '$semester'
                                    ")->row_array();
