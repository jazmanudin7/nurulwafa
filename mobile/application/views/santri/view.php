<div class="appHeader bg-primary ">
    ...
    <div class="right">
        ...
        <a href="<?php echo base_url(); ?>santri/input" class="headerButton">
...
<ul class="listview image-listview">
    <?php foreach ($data as $d) { ?>
        <li>
            <a href="<?php echo base_url(); ?>santri/edit/<?php echo $d['nps']; ?>" class="item">
                <div class="in">
                    <div>
                        <header><?php echo $d['nps']; ?></header>
                        <?php echo $d['nama_santri']; ?>
                        <footer><?php echo $d['nama_asrama']; ?> - <?php echo $d['nama_kelas']; ?></footer>
                    </div>
                    <span class="text-muted"><?php echo $d['jk']; ?></span>
                </div>
            </a>
        </li>
    <?php } ?>
