<div class="appHeader bg-primary ">
    <div class="left">
        <a href="<?php echo base_url(); ?>absensi/viewAbsensiMengaji" class="headerButton">
            <ion-icon name="chevron-back-outline"></ion-icon>
        </a>
        Detail Absensi Mengaji
    </div>
    <div class="right">
        <a href="<?php echo base_url(); ?>absensi/editAbsensiMengaji/<?php echo $absensi['no_absensi']; ?>" class="headerButton">
...
<ul class="listview image-listview">
    <li>
        <div class="item">
            <div class="in">
                <div>
                    <header><?php echo $absensi['tahun_ajaran']; ?> - <?php echo $absensi['semester']; ?></header>
                    <?php echo $absensi['nama_kelas']; ?>
                    <footer><?php echo $absensi['nama_kitab']; ?></footer>
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.keterangan').click(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>absensi/updateKeteranganAbsensiMengaji",
                data: {
        ...
        $('#hapus').click(function() {
            ...
            swal({
                ...
                if (result.value) {
                    ...
                    $(location).attr('href', '<?php echo base_url() ?>absensi/hapusAbsensiMengaji/' + kode);
                }
            })
        });
