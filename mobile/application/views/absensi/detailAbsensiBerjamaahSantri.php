<div class="appHeader bg-primary ">
    ...
    <div class="pageTitle">
        Detail Absensi Berjamaah
    </div>
</div>

<ul class="listview image-listview">
    <li>
        <form class="form" autocomplete="off" role="form" id="form" action="<?php echo base_url(); ?>absensi/detailAbsensiBerjamaahSantri" novalidate method="POST" enctype="multipart/form-data">
            <div class="item">
                <div class="in">
                ...
                <div class="in">
                    <select class="form-control" name="shalat">
                        <option <?php if ($shalat == 'Subuh') {
                                    echo "selected";
                                } ?> value="Subuh">Subuh</option>
                        <option <?php if ($shalat == 'Dzuhur') {
                                    echo "selected";
                                } ?> value="Dzuhur">Dzuhur</option>
                        <option <?php if ($shalat == 'Ashar') {
                                    echo "selected";
                                } ?> value="Ashar">Ashar</option>
                        <option <?php if ($shalat == 'Magrib') {
                                    echo "selected";
                                } ?> value="Magrib">Magrib</option>
                        <option <?php if ($shalat == 'Isya') {
                                    echo "selected";
    ...
    ?>
        <li>
            <a href="#" class="item">
                <div class="in">
                    <div>
                        <header><?php echo DateToIndo($d->tanggal); ?></header>
