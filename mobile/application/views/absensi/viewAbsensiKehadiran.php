<div class="appHeader bg-primary ">
    ...
    <div class="right">
        <a href="<?php echo base_url(); ?>absensi/inputAbsensiKehadiran" class="headerButton">
...
<ul class="listview image-listview">
    <?php foreach ($data as $d) { ?>
        <li>
            <a href="<?php echo base_url(); ?>absensi/detailAbsensiKehadiran/<?php echo $d['no_absensi']; ?>" class="item">
                <div class="in">
                    <div>
                        <header><?php echo $d['tahun_ajaran']; ?></header>
                        <?php echo $d['nama_asrama']; ?>
                        <footer><?php echo $d['semester']; ?></footer>
                    </div>
