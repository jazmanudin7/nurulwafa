<div class="appHeader bg-primary ">
    <div class="left">
        ...
        View Absensi Berjamaah
    </div>
    <div class="right">
        <a href="<?php echo base_url(); ?>absensi/inputAbsensiBerjamaah" class="headerButton">
...
<ul class="listview image-listview">
    <?php foreach ($data as $d) { ?>
        <li>
            <a href="<?php echo base_url(); ?>absensi/detailAbsensiBerjamaah/<?php echo $d['no_absensi']; ?>" class="item">
                <div class="in">
                    <div>
                        <header><?php echo $d['tahun_ajaran']; ?> - <?php echo $d['semester']; ?></header>
                        <?php echo $d['nama_asrama']; ?>
                        <footer><?php echo $d['shalat']; ?></footer>
                    </div>
