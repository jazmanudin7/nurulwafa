                            ...
                            <form class="form-horizontal" method="post" action="" autocomplete="off">
                                ...
                                <div class="row clearfix">
                                    <div class="form-group">
                                        <div class="col-lg-3 col-md-4 col-sm-8 col-xs-7">
                                            <div class="form-line">
                                                <input type="text" value="<?php echo $nama_kelas; ?>" id="nama_kelas" name="nama_kelas" class="form-control" placeholder="Nama Kelas">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-4 col-sm-8 col-xs-7">
                                    ...
                                    <tr id="">
                                        ...
                                        <td>
                                            <div class="text-center">
                                                <a class="hapus fa fa-trash btn-danger btn btn-sm" data-id="<?php echo $d['kode_kelas']; ?>"></a>
                                                <a class="edit fa fa-edit btn-warning btn btn-sm" data-id="<?php echo $d['kode_kelas']; ?>"></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php } ?>
...
<div id="modal-kelas" class="modal fade" aria-hidden="true">
...
<script type="text/javascript">
    $(function() {
        ...
        $('.input').click(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>kelas/input",
                data: {
                    kode_kelas: kode_kelas
                },
                cache: false,
