                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo strtoupper($d->nama_santri); ?></td>
                                <td><?php echo $d->nama_kelas; ?></td>
                                <td><?php echo $d->nama_asrama; ?></td>
                                <td><?php echo $d->jk; ?></td>
                                <td><?php echo strtoupper($d->tempat_lahir); ?></td>
                                <td><?php if($d->tgl_lahir != '0000-00-00' ){ echo DateToIndo($d->tgl_lahir); } ?></td>
                                <td><?php echo strtoupper($d->alamat); ?></td>
                                <td><?php echo strtoupper($d->kota); ?></td>
                                <td><?php echo strtoupper($d->konsulat); ?></td>
                                <td><?php echo strtoupper($d->nama_ayah); ?></td>
                                <td><?php echo strtoupper($d->pekerjaan_ayah); ?></td>
                                <td><?php echo strtoupper($d->pendidikan_ayah); ?></td>
                                <td><?php echo strtoupper($d->nama_ibu); ?></td>
                                <td><?php echo strtoupper($d->pekerjaan_ibu); ?></td>
                                <td><?php echo strtoupper($d->pendidikan_ibu); ?></td>
                                <td><?php echo strtoupper($d->alamat_ortu); ?></td>
