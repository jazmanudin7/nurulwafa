        ...
        <div class="col-lg-4">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <h5 class="card-title" align="center">LAPORAN ABSENSI MENGAJI</h5>
                    <form autocomplete="off" class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>laporan/cetakAbsensiMengaji" target="_blank">
                        ...
                        <div class="form-group">
                            <select class="form form-control chosen-select" name="kode_kelas" id="kode_kelas">
                        ...
                        <div class="form-group">
                            <select class="form form-control chosen-select" name="kode_kitab" id="kode_kitab">
                        ...
                        <div class="form-group">
                            <select class="form form-control chosen-select" name="tahun_ajaran" id="tahun_ajaran">
                        ...
                        <div class="form-group">
                            <select required class="form-control chosen-select" name="semester">
