...
<script type="text/javascript">
    $(function() {
        ...
        $('.detail').click(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>absensi/detailAbsensiBerjamaah",
                data: {
        ...
        $('.edit').click(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>absensi/editAbsensiBerjamaah",
                data: {
                    no_absensi: no_absensi
                },
                cache: false,
        ...
        $('.input').click(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>absensi/inputAbsensiBerjamaah",
                data: {
                    no_absensi: no_absensi
                },
                cache: false,
